...
export const createClassifyQuestionTool = (chatId: string) => tool({
    ...
    inputSchema: z.object({
        ...
        questionText: z.string().describe('The actual question the customer asked, summarized clearly (e.g., "Where is my order?", "How do I track my shipment?", "Do you offer student discounts?")'),
    }),
