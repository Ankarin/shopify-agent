...
const components: Options["components"] = {
  ...
  a: ({ node, children, className, ...props }) => {
    const isUrl = typeof children === 'string' && (children.startsWith('http://') || children.startsWith('https://'));
    const truncatedChildren = isUrl && children.length > 50
      ? `${children.substring(0, 47)}...`
      : children;
